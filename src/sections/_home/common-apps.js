...
export default function CommonApps() {
  ...
  return (
    ...
    >
      ...
      <Image
        alt="landing about"
        src="/assets/screenshots/task with history and subtasks.png"
        ratio="16/9"
        width={640} // Add the "width" property with a valid value
        height={480} // Add the "height" property with a valid value
        sx={{
          borderRadius: 1.5,
          mb: { xs: 5, md: 10 }
        }}
